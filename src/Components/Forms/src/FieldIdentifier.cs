...
{
    private static readonly ConcurrentDictionary<(Type ModelType, MemberInfo FieldName), Func<object, object>> _fieldAccessors = new();
    ...
    internal static object GetModelFromMemberAccess(
        ...
        ConcurrentDictionary<(Type ModelType, MemberInfo FieldName), Func<object, object>>? cache = null)
    {
