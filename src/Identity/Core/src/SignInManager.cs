...
public class SignInManager<TUser> where TUser : class
{
    ...
    private async Task<IdentityResult> ResetLockoutWithResult(TUser user)
    {
        ...
        try
        {
            ...
            // REVIEW: Is it worth checking if the ResetLockout task is a Task<IdentityResult>?
            // This could matter if derived classes didn't call base.ResetLockout(user) or await and
            // instead directly returned UserManager.ResetAccessFailedCountAsync(user) like we used to.
